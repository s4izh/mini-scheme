...
typedef struct _lexer_test_helper lexer_test_helper;

struct _lexer_test_helper {
...
static MunitResult test_lexer_boolean_literal(const MunitParameter params[], void* fixture)
{
    scm_resources_t* resources = (scm_resources_t*)fixture;
    scm_lexer_t lexer;
    ...
    append_token(&expected_tokens, resources, SCM_TOKEN_LITERAL_BOOLEAN, "#t", 0);
    append_token(&expected_tokens, resources, SCM_TOKEN_EOF, NULL, 0);
...
static MunitResult test_lexer_string_escapes(const MunitParameter params[], void* fixture)
{
    ...
    append_token(&expected_tokens, resources, SCM_TOKEN_LITERAL_STRING, "\"st\\\"ri\\\"ng\"", 0);
    append_token(&expected_tokens, resources, SCM_TOKEN_EOF, NULL, 0);
...
static MunitResult test_lexer_factorial(const MunitParameter params[], void* fixture)
{
    ...
    append_token(&expected_tokens, resources, SCM_TOKEN_LPAREN, "(", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_IDENTIFIER, "*", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_IDENTIFIER, "n", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_LPAREN, "(", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_IDENTIFIER, "factorial", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_LPAREN, "(", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_IDENTIFIER, "-", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_IDENTIFIER, "n", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_LITERAL_NUMBER, "1", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_RPAREN, ")", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_RPAREN, ")", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_RPAREN, ")", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_RPAREN, ")", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_RPAREN, ")", 3);
    append_token(&expected_tokens, resources, SCM_TOKEN_LPAREN, "(", 5);
    append_token(&expected_tokens, resources, SCM_TOKEN_IDENTIFIER, "factorial", 5);
    append_token(&expected_tokens, resources, SCM_TOKEN_LITERAL_NUMBER, "5", 5);
    append_token(&expected_tokens, resources, SCM_TOKEN_RPAREN, ")", 5);
    append_token(&expected_tokens, resources, SCM_TOKEN_EOF, NULL, 7);
...
static MunitTest scm_lexer_suite_tests[] = {
    ...
    basic_test("/string-escapes", test_lexer_string_escapes),
    basic_test("/boolean-literal", test_lexer_boolean_literal),
